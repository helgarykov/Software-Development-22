...
public class GameOver : IBreakoutGameState, IGameEventProcessor
{
    ...
    /// <summary>
    /// Method that defines position and color of GameOver buttons and Finaltexts.
    /// </summary>
    ...
    public void ResetState()
    {
        ...
        _activeMenuButton = 0;
        _newHigh = false;
        new HighScore(GameRunning.Points);
        _name = "";
        ReadHighScore();
        InitializeAllText();
    }
    ...
    /// <summary>
    /// Renders backgroundImage, menuButtons, finalTexts and Points.
    /// </summary>
    ...
    /// <summary>
    /// At pressing any keyboard button, the game switches to the MainMenu state.
    /// </summary>
